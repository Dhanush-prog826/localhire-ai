...
export const JobDetailModal: React.FC<JobDetailModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-zinc-950 rounded-2xl sm:rounded-3xl shadow-2xl border border-blue-900/60 w-full max-w-xl overflow-hidden z-10 my-auto text-zinc-100 animate-in zoom-in-95 duration-150">
        {/* Top glowing laser line */}
        <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-blue-600 via-cyan-400 to-sky-400 shadow-[0_0_15px_rgba(56,189,248,0.8)]" />
        ...
        <div className="bg-gradient-to-r from-zinc-950 via-blue-950/60 to-zinc-950 p-5 sm:p-6 text-white relative border-b border-blue-950/60">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold font-mono bg-blue-950/70 text-cyan-300 border border-cyan-500/40">
              {job.jobType}
            </span>
          </div>
        ...
        <div className="p-5 sm:p-6 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div className="bg-gradient-to-r from-blue-950/40 via-zinc-900 to-zinc-950 border border-cyan-500/50 rounded-2xl p-4 flex items-center justify-between gap-4 shadow-inner">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-600 text-white flex flex-col items-center justify-center shadow-lg shadow-blue-950/50 border border-cyan-400/40 shrink-0 font-mono">
            ...
            <div className="hidden sm:block text-right shrink-0">
              <span className="text-xs font-semibold px-2.5 py-1 rounded-lg bg-zinc-900 border border-cyan-500/50 text-cyan-300 shadow-2xs font-mono">
                Verified Clearance
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3">
              ...
              <p className="text-[10px] text-zinc-500 mt-0.5 flex items-center gap-0.5 font-mono">
                <Navigation className="w-2.5 h-2.5 text-cyan-400" /> ~7 min cycle
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {job.requiredSkills.map((skill, idx) => (
                  <span
                    key={idx}
                    className="px-2.5 py-1 rounded-lg text-xs font-medium font-mono bg-blue-950/40 text-cyan-200 border border-blue-900/50"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <button
              ...
              className={`flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all shadow-xs cursor-pointer font-mono ${
                applied
                  ...
                  : 'bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-700 hover:from-blue-500 hover:to-cyan-500 text-white shadow-lg shadow-blue-950/50 hover:shadow-cyan-500/30 border border-cyan-400/40 active:scale-98'
              }`}
            >
              {applied ? (
                <>
