...
export const ApplicationTimelineModal: React.FC<ApplicationTimelineModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-zinc-950 rounded-3xl shadow-2xl border border-blue-900/60 w-full max-w-md overflow-hidden z-10 my-auto">
        {/* Laser line on top */}
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 via-cyan-400 to-blue-600" />

        {/* Header */}
        <div className="bg-gradient-to-r from-zinc-950 via-blue-950/60 to-zinc-950 p-5 text-white relative border-b border-blue-950/60">
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-bold bg-blue-950/70 text-cyan-300 border border-blue-800/60 flex items-center gap-1">
        ...
        <div className="p-5 space-y-6 max-h-[70vh] overflow-y-auto">
          ...
          <div className="bg-zinc-900/80 border border-blue-900/50 rounded-2xl p-3.5 flex items-center justify-between">
            <div>
          ...
          <div>
            ...
            {isRejected ? (
              <div className="bg-zinc-900 border border-rose-900/60 rounded-2xl p-4 text-zinc-300 text-xs font-mono">
                <p className="font-bold text-rose-400 mb-1">Application Closed</p>
                    ...
                    <div key={stage} className="relative flex items-start gap-3.5 pl-1">
                      ...
                      <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-mono font-bold shrink-0 z-10 transition-all ${
                          isCurrent
                            ? 'bg-cyan-500 text-zinc-950 ring-4 ring-cyan-500/30 scale-110 shadow-lg shadow-cyan-950'
                            : isCompleted
