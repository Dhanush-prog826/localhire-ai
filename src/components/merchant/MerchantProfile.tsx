...
export const MerchantProfile: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="bg-zinc-950/90 border border-red-950/60 rounded-3xl p-5 sm:p-7 shadow-xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-3 gap-2 mt-5 pt-4 border-t border-zinc-800/80 text-center font-mono">
          <div className="bg-zinc-900/70 border border-zinc-800/80 rounded-xl p-2.5">
            <p className="text-base sm:text-lg font-extrabold text-red-400">
              {merchantJobs.length}
            </p>
          ...
          <div className="bg-zinc-900/70 border border-zinc-800/80 rounded-xl p-2.5">
            <p className="text-base sm:text-lg font-extrabold text-orange-400">
              {applicants.length}
            </p>
            <p className="text-[10px] text-zinc-400 uppercase font-semibold">
              Total Applicants
      ...
      <div className="bg-zinc-950/90 border border-red-950/60 rounded-3xl p-5 sm:p-7 shadow-xl space-y-5 font-mono">
