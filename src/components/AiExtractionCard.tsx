...
export const AiExtractionCard: React.FC<AiExtractionCardProps> = ({
  ...
  if (isAnalyzing) {
    return (
      <div className="relative bg-zinc-950/90 border border-cyan-500/50 rounded-2xl p-5 shadow-lg shadow-blue-950/20 overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 via-cyan-400 to-sky-400 animate-[laser-sweep_2s_ease-in-out_infinite]" />
  ...
  return (
    <div className="relative bg-zinc-950/90 border border-blue-950/60 hover:border-cyan-500/60 rounded-2xl p-5 shadow-lg transition-all overflow-hidden group">
      {/* Top laser accent */}
      <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 via-cyan-400 to-sky-400 opacity-80" />

      <div className="flex items-center justify-between mb-3.5 pt-0.5">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-lg bg-blue-950/40 border border-blue-800/40 flex items-center justify-center text-cyan-400 shadow-xs">
        ...
        <div className="flex items-center gap-1 text-[10px] font-mono font-bold text-cyan-400 bg-blue-950/50 px-2.5 py-1 rounded-full border border-cyan-500/40">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        {/* Job Type */}
        <div className="bg-zinc-900/80 border border-zinc-800/80 rounded-xl p-3 hover:border-cyan-500/40 transition-colors">
